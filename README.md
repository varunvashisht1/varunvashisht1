...
[![What I do](https://readme-typing-svg.demolab.com/?font=Inter&weight=600&size=20&duration=2600&pause=800&color=6366F1&vCenter=true&width=520&height=36&lines=Programme+delivery;Business+architecture;AI+in+the+PMO;Built+on+the+Cloudflare+edge)](https://varunvashisht.com)
...
<a href="https://varunvashisht.com"><img src="https://varunvashisht.com/og/profile.svg" width="820" alt="Varun Vashisht — live status, rendered at the Cloudflare edge" /></a>
...
```mermaid
flowchart LR
    U(Visitor) --> R{{"varunvashisht.com<br/>router Worker"}}
    R -->|/| M["Main · portfolio"]
    R -->|/lab| L["Lab · 139 AI tools"]
    R -->|/studio| S["Studio · consulting"]
    R -->|/blog| B["Blog · Insights"]
    M & L & S & B --> E[("Workers AI · D1 · KV · R2")]
```
...
<!-- BLOG-POST-LIST:START -->- [What the model can&#39;t see in your project.](https://varunvashisht.com/blog/what-the-model-cant-see/)<br/>- [The four-way field test: Fable, Sonnet 5, Kimi, and the GPT you can buy today.](https://varunvashisht.com/blog/the-four-way-field-test/)<br/>- [The most expensive way to sound like everyone else.](https://varunvashisht.com/blog/the-most-expensive-way-to-sound-like-everyone-else/)<br/>- [Which model, when. And do we really need Fable?](https://varunvashisht.com/blog/which-model-when/)<br/><!-- BLOG-POST-LIST:END -->
...
<details>
<summary><b>🧰 Tools &amp; certifications</b></summary>
